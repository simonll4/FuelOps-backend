...
@EnableJpaRepositories(basePackages = "ar.edu.iw3", // ar.edu.iw3.integration.cli2.model.controller
        excludeFilters = {
                @ComponentScan.Filter(type = FilterType.REGEX, pattern = "ar\\.edu\\.iw3\\.integration\\.cli2\\..*" )
...
@EntityScan(basePackages = {
        "ar.edu.iw3.model",
        "ar.edu.iw3.auth",
        "ar.edu.iw3.integration.cli1.model"
},
        basePackageClasses = {
...
@ConditionalOnExpression(value = "'${spring.profiles.active:-}'=='cli1' OR '${spring.profiles.active:-}'=='mysqldev'")
