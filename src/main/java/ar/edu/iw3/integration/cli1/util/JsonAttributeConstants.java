...
public class JsonAttributeConstants {
    ...
    public static final String[] TANKER_CAPACITY_ATTRIBUTES = {"capacity_liters", "capacity"};
    public static final String[] TANKER_IDCLI1_ATTRIBUTES = {"id", "id_tanker", "code", "tanker_code"};
    public static final String[] TANKER_LICENSE_ATTRIBUTES = {"license", "license_plate", "plate"};
